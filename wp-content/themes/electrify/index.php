        ...
        if($blog_style == 'timeline' || $blog_style == 'masonry_with_sb'){ 
            echo '<div class="clear">';
                ...
                if (have_posts()) : while (have_posts()) : the_post();
                    ...
                    $first_cat =  '<a href="' . get_category_link( $category[0]->term_id ) . '" title="' . sprintf( __( "View all posts in %s", 'electrify'), $category[0]->name ) . '" ' . '>' . $category[0]->name.'</a> ';
                        ...
                        $meta = '<div class="byline vcard clearfix">
                            ...
                            if($blog_style != 'grid' && $blog_style != 'grid_with_sb' && $blog_style != 'masonry' && $blog_style != 'masonry_with_sb'){
                                ...
                                $meta .= sprintf( __( '<span class="tag"><i class="pixicon pixicon-eleganticons-217"></i> %1$s </span>', 'electrify' ),get_the_category_list(', '));    
                            }
                        ...
                        if ('open' == $post->comment_status){     
                            $meta .= '<span class="pix-blog-comments"><i class="pixicon pixicon-eleganticons-196"></i>'. get_comments_popup_link(__('No Comments','electrify'), __('1 Comment','electrify'), __('% Comments','electrify'), __('comments-link','electrify'), '') .'</span>';
                        }
        ...
        if($blog_style != 'grid' && $blog_style != 'masonry' && $blog_style != 'timeline'){
            ...
            if ( function_exists( 'pixel8es_page_navi' ) ) {
                ...
                echo '<nav class="wp-prev-next ">
                        <ul class="clearfix">
                            <li class="prev-link">'.next_posts_link( __( '&laquo; Older Entries', 'electrify' )).'</li>
                            <li class="next-link">'.previous_posts_link( __( 'Newer Entries &raquo;', 'electrify' )).'</li>
                        </ul>
                </nav>';
            } 
