            ...
            ?>
        			...
        			<div class="<?php echo $pix_col_class; ?>">
                        ...
                        <header class="title-header">
                            ...
                            <?php 
                                echo  (!empty($author_name) ? '<p class="author"><em>' .__('By','electrify').'</em> <em class="base-color">'. $author_name .'</em></p>' : ''); 
                            ?>                    
                        </header>
                        ...
                        <?php
                            if($portfolio_layout == "full"){  ?>                  
                                ...
                                <?php if(!empty($project_url)){ ?>                                
                                    <a href="<?php echo esc_url($project_url);?>" title="" target="<?php echo $pix_button_target ?>" class="clear btn btn-outline single-portfolio-btn btn-md color"><?php if(empty($pix_portfolio_text)){ _e('Launch Project','electrify'); } else{ echo $pix_portfolio_text ; } ?></a>
                                <?php } ?>
                                ...
                                <?php
                                    if($pix_show_like == 'yes'){
                                        ...
                                        echo '<a href="#void" class="single-port-like pix-like-me '. $like_class .'" data-id="'. $post->ID .'"><i class="pixicon-heart-2"></i><span class="like-count">'. $like_count .'</span><span class="already-liked">'. __('You already liked this!','electrify') .'</span></a>';
        	...
        	<?php
                if(!empty($pix_skills) || !empty($pix_task) || !empty($pix_client_name) || !empty($terms)){
                    ...
                    echo '<div class="'. (($portfolio_layout == "right") ? 'portfolio-layout-right-bottom' : 'col-md-3') .'">';
                        ...
                        echo '<h2 class="title">'. __('Details', 'electrify') .'</h2>';
                        echo '<ul>';
