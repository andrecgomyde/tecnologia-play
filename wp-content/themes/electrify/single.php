<?php get_header();
    ...
    $s_author_t = isset($smof_data['s_author_t']) ? $smof_data['s_author_t'] : __('About the Author','electrify');
    $s_related = isset($smof_data['s_related']) ? $smof_data['s_related'] : 1;
    $s_related_t = isset($smof_data['s_related_t']) ? $smof_data['s_related_t'] : __('Related Posts','electrify');
    ...
    if(empty($s_author_t)){
        $s_author_t = __('About the Author','electrify');
    }
                ...
                if($s_meta){
                    ...
                    $meta = '<div class="byline vcard clearfix">
                                <p class="pull-left category">
                                    '
                                    .sprintf( __( '<span class="tag"><i class="pixicon pixicon-eleganticons-217"></i> %1$s </span>', 'electrify' ),$category).'<span class="pix-blog-comments">'. get_comments_popup_link(__('<i class="pixicon pixicon-eleganticons-196"></i> No Comments','electrify'), __('<i class="pixicon pixicon-eleganticons-196"></i> 1 Comment','electrify'), __('<i class="pixicon pixicon-eleganticons-196"></i> % Comments','electrify'), __('comments-link','electrify'), '') .'</span>
