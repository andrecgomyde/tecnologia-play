...
<?php
	$copyright_text = isset($smof_data['copyright_text']) ? $smof_data['copyright_text'] : '<p>&copy; '. date("Y") .' [blog-link], All Rights Reserved.</p>';
	...
	if(empty($f_copyright_t)){
		$f_copyright_t= do_shortcode('<p>&copy; '. date("Y") .' [blog-link], All Rights Reserved.</p>');	
	}
		...
		<div id="pageFooterCon" class="pageFooterCon <?php echo $f_widget_col; ?> clearfix">
			...
			<div id="pageFooter" class="container">
				...
				?>
					...
					<div>
					<p><?php _e("Please activate some Widgets Or disable it from theme option", "electrify");  ?></p>
					</div>
