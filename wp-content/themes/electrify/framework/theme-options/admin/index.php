...
if( !defined('ADMIN_PATH') )
	define( 'ADMIN_PATH', get_template_directory() . '/framework/theme-options/admin/' );
if( !defined('ADMIN_DIR') )
	define( 'ADMIN_DIR', get_template_directory_uri() . '/framework/theme-options/admin/' );
 ...
 * @since 1.0.0
 */ 
electrify_require_file ( ADMIN_PATH . 'functions/functions.load.php' );
electrify_require_file ( ADMIN_PATH . 'classes/class.options_machine.php' );
