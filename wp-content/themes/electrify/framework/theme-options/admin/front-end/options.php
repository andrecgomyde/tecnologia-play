<div class="wrap" id="of_container">
	...
	<div id="of-popup-save" class="of-save-popup">
		<div class="of-save-save"><i class="icon-check-mark"></i> <?php _e('Options Updated','electrify');?></div>
	</div>
	
	<div id="of-popup-reset" class="of-save-popup">
		<div class="of-save-reset"><i class="icon-refresh"></i> <?php _e('Options Reset','electrify'); ?></div>
	</div>
	
	<div id="of-popup-fail" class="of-save-popup">
		<div class="of-save-fail"><i class="icon-remove"></i> <?php _e('Error! Not Saved','electrify'); ?></div>
	</div>
	...
	<form id="of_form" method="post" action="<?php echo esc_attr( $_SERVER['REQUEST_URI'] ) ?>" enctype="multipart/form-data" >
		...
		<div id="header">
			...
			<div id="js-warning"><?php _e('Warning- This options panel will not work properly without javascript!','electrify'); ?></div>
			...
			<div id="info_bar">
				...
				<div class="btn-bg">
					<button id="of_save" type="button" class="btn-pri">
						...
						<?php _e('Save All Changes', 'electrify');?>
					</button>
				</div>
		...
		<div id="main">
			...
			<div id="content">
				<div id="no-result" class="section-info">
					<div class="controls">
						<div class="of-info">
							<h3><?php _e('No Result Found!', 'electrify'); ?></h3>
						</div>
					</div>
				</div>
				...
				<div class="save_bar"> 
					...
					<button id ="of_save" type="button" class="btn-sec"><i class="pix-icon icon-pix-fonts-22"></i> <?php _e('Save All Changes', 'electrify');?></button>			
					<button id ="of_reset" type="button" class="button submit-button reset-button" ><?php _e('Options Reset', 'electrify');?></button>
