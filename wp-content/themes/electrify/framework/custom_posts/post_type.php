...
function my_edit_pix_portfolio_columns( $columns ) {
	...
	$columns = array(
		...
		'title' => __( 'All portfolio', 'electrify' ),
		'id' => __( 'Portfolio Id', 'electrify' ),
		'thumb' => __( 'Portfolio Image', 'electrify' ),
		'date' => __( 'Date', 'electrify' )
	);
...
function my_edit_pix_staffs_columns( $columns ) {
	...
	$columns = array(
		'cb' => '<input type="checkbox" />',
		'title' => __( 'All Saffs', 'electrify' ),
		'id' => __( 'Staff Id', 'electrify' ),
		'thumb' => __( 'Staff Image', 'electrify' ),
		'date' => __( 'Date', 'electrify' )
	);
...
function my_edit_pix_testimonial_columns( $columns ) {
	...
	$columns = array(
		'cb' => '<input type="checkbox" />',
		'title' => __( 'All Testimonial', 'electrify' ),
		'id' => __( 'Testimonial Id', 'electrify' ),
		'thumb' => __( 'Client Image', 'electrify' ),
		'date' => __( 'Date', 'electrify' )
	);
