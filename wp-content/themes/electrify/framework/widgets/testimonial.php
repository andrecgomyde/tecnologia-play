...
class Pix_Testimonial_Widget extends WP_Widget {
	...
	function __construct() {
		$widget_options = array('classname' => 'testimonial-widget', 'description' => __('Display Testimonial','electrify'));
		parent::__construct('pix_testimonial',__('Pixel8es:: Testimonial','electrify'),$widget_options);
	}

	function widget( $args, $instance ) {
		extract($args);
		
		$title = ($instance['title']) ? $instance['title'] : __('Testimonial','electrify');
...
?>
		...
		<p><label for="<?php echo $this->get_field_id('limit'); ?>"><?php _e('Limit:', 'electrify'); ?></label>
        ...
        <?php _e( 'Testimonial Style:','electrify' ) ?></label>
		...
		<p><label for="<?php echo $this->get_field_id('rating_no');?>">
			<?php _e( 'Show/Hide Rating Icons:','electrify' ) ?></label>
        ...
        <?php _e( 'Testimonial Count (Max 20):','electrify' ) ?></label>
        ...
        <?php _e( 'Order By:','electrify' ) ?></label>
