...
class Pix_Popular_Post_Widget extends WP_Widget {
	...
	function __construct() {
		$widget_options = array('classname' => 'popularpost', 'description' => __('Display Popular Posts','electrify'));
		parent::__construct('pix_popular_post',__('Pixel8es:: Popular Post','electrify'),$widget_options);
	}
	...
	function widget($args, $instance) {
		...
		$title = ( ! empty( $instance['title'] ) ) ? $instance['title'] : __( 'Popular Posts','electrify' );
...
<?php
	...
	function form( $instance ) {
		$title     = isset( $instance['title'] ) ? esc_attr( $instance['title'] ) : __( 'Popular Posts', 'electrify' );
...
?>
		...
		<p><label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php _e( 'Number of posts to show:', 'electrify' ); ?></label>
		<input id="<?php echo $this->get_field_id( 'number' ); ?>" name="<?php echo $this->get_field_name( 'number' ); ?>" type="text" value="<?php echo esc_attr($number); ?>" size="3" /></p>

		<p><input class="checkbox" type="checkbox" <?php checked( $show_date ); ?> id="<?php echo $this->get_field_id( 'show_date' ); ?>" name="<?php echo $this->get_field_name( 'show_date' ); ?>" />
		<label for="<?php echo $this->get_field_id( 'show_date' ); ?>"><?php _e( 'Display post date?', 'electrify' ); ?></label></p>
		...
		<label for="<?php echo $this->get_field_id( 'show_image' ); ?>"><?php _e( 'Display post image?', 'electrify' ); ?></label></p>
