...
class Pix_portfolio_Member_Widget extends WP_Widget {
	...
	function __construct() {
		$widget_options = array('classname' => 'portfolio-member', 'description' => __('Display Picture Gallery','electrify'));
		parent::__construct('pix_portfolio_member',__('Pixel8es:: Custom Post Gallery','electrify'),$widget_options);
	}

	function widget( $args, $instance ) {
		extract($args);
		
		$title = ($instance['title']) ? $instance['title'] : __('Gallery','electrify');
...
?>
        ...
        <?php _e('Choose Custom Post:','electrify'); ?>
        ...
        <?php _e('Gallery Count (Max 20):','electrify'); ?>
