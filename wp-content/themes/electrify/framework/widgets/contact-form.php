...
class Pix_Contact_Widget extends WP_Widget {
	...
	function __construct() {
		$widget_options = array('classname' => 'contact-form-widget', 'description' => __('Display Contact Form','electrify'));
		parent::__construct('pix_contact_form',__('Pixel8es:: Contact Form','electrify'),$widget_options);
	}

	function widget( $args, $instance ) {
		extract($args);
		
		$title = ($instance['title']) ? $instance['title'] : __('Contact','electrify');
...
?>
		...
		<p><label for="<?php echo $this->get_field_id('id'); ?>"><?php _e('Contact Form ID:', 'electrify'); ?></label>
