...
class Pix_Recent_Post_Widget extends WP_Widget {
	...
	function __construct() {
		$widget_options = array('classname' => 'recentpost', 'description' => __('Display Recent Posts','electrify'));
		parent::__construct('pix_recent_post',__('Pixel8es:: Recent Post','electrify'),$widget_options);
	}
...
<?php
	...
	function form( $instance ) {
		$title     = isset( $instance['title'] ) ? esc_attr( $instance['title'] ) : __( 'Recent Posts', 'electrify' );
