...
class Pix_LikeBox_Widget extends WP_Widget {
	...
	function __construct() {
		$widget_options = array('classname' => 'likebox-widget', 'description' => __('Display Facebook Like Box','electrify'));
		parent::__construct('pix_likebox_widget',__('Pixel8es:: Facebook Like Box','electrify'),$widget_options);
	}
...
?>
		...
		<p><label for="<?php echo $this->get_field_id('fb_page_url'); ?>"><?php _e('Facebook Page URL:', 'electrify'); ?></label>
        ...
        <?php _e( 'Color Scheme:','electrify' ) ?>
            <select id="<?php echo $this->get_field_id('color_scheme');?>" name="<?php echo $this->get_field_name('color_scheme');?>">
                <option value="light" <?php selected( $color_scheme, "light" ); ?>><?php _e('Light', 'electrify'); ?></option>
                <option value="dark" <?php selected( $color_scheme, "dark" ); ?>><?php _e('Dark', 'electrify'); ?></option>
            </select>
		</p>

		<p><label for="<?php echo $this->get_field_id('show_faces');?>"></label>
        <?php _e( 'Show Friends Faces:','electrify' ) ?>
            <select id="<?php echo $this->get_field_id('show_faces');?>" name="<?php echo $this->get_field_name('show_faces');?>">
                <option value="true" <?php selected( $show_faces, "true" ); ?>><?php _e('Yes', 'electrify'); ?></option>
                <option value="false" <?php selected( $show_faces, "false" ); ?>><?php _e('No', 'electrify'); ?></option>
            </select>
		</p>

		<p><label for="<?php echo $this->get_field_id('show_headers');?>"></label>
        <?php _e( 'Show Headers:','electrify' ) ?>
            <select id="<?php echo $this->get_field_id('show_headers');?>" name="<?php echo $this->get_field_name('show_headers');?>">
                <option value="true" <?php selected( $show_headers, "true" ); ?>><?php _e('Yes', 'electrify'); ?></option>
                <option value="false" <?php selected( $show_headers, "false" ); ?>><?php _e('No', 'electrify'); ?></option>
            </select>
		</p>

		<p><label for="<?php echo $this->get_field_id('show_posts');?>"></label>
        <?php _e( 'Show Posts:','electrify' ) ?>
            <select id="<?php echo $this->get_field_id('show_posts');?>" name="<?php echo $this->get_field_name('show_posts');?>">
                <option value="true" <?php selected( $show_posts, "true" ); ?>><?php _e('Yes', 'electrify'); ?></option>
                <option value="false" <?php selected( $show_posts, "false" ); ?>><?php _e('No', 'electrify'); ?></option>
            </select>
		</p>

		<p><label for="<?php echo $this->get_field_id('show_borders');?>"></label>
        <?php _e( 'Show Borders:','electrify' ) ?>
            <select id="<?php echo $this->get_field_id('show_borders');?>" name="<?php echo $this->get_field_name('show_borders');?>">
                <option value="true" <?php selected( $show_borders, "true" ); ?>><?php _e('Yes', 'electrify'); ?></option>
                <option value="false" <?php selected( $show_borders, "false" ); ?>><?php _e('No', 'electrify'); ?></option>
            </select>
		</p>
