...
class Pix_Map_Widget extends WP_Widget {
	...
	function __construct() {
		$widget_options = array('classname' => 'map-widget', 'description' => __('Display Google Map','electrify'));
		parent::__construct('pix_map_widget',__('Pixel8es:: Google Map','electrify'),$widget_options);
	}
...
?>
		...
		<p><label for="<?php echo $this->get_field_id('height'); ?>"><?php _e('Height:', 'electrify'); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id('lat'); ?>"><?php _e('Latitude:', 'electrify'); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id('lng'); ?>"><?php _e('Longitude:', 'electrify'); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id('zoom'); ?>"><?php _e('Zoom:', 'electrify'); ?></label>
        ...
        <?php _e( 'Zoom Control:','electrify' ) ?>
            <select id="<?php echo $this->get_field_id('zoom_control');?>" name="<?php echo $this->get_field_name('zoom_control');?>">
                <option value="true" <?php selected( $zoom_control, "true" ); ?>><?php _e('Yes', 'electrify'); ?></option>
                <option value="false" <?php selected( $zoom_control, "false" ); ?>><?php _e('No', 'electrify'); ?></option>
            </select>
		</p>

		<p><label for="<?php echo $this->get_field_id('pan_control');?>"></label>
        <?php _e( 'Pan Control:','electrify' ) ?>
            <select id="<?php echo $this->get_field_id('pan_control');?>" name="<?php echo $this->get_field_name('pan_control');?>">
                <option value="true" <?php selected( $pan_control, "true" ); ?>><?php _e('Yes', 'electrify'); ?></option>
                <option value="false" <?php selected( $pan_control, "false" ); ?>><?php _e('No', 'electrify'); ?></option>
            </select>
		</p>

		<p><label for="<?php echo $this->get_field_id('map_type_control');?>"></label>
        <?php _e( 'Map Type Control:','electrify' ) ?>
            <select id="<?php echo $this->get_field_id('map_type_control');?>" name="<?php echo $this->get_field_name('map_type_control');?>">
                <option value="true" <?php selected( $map_type_control, "true" ); ?>><?php _e('Yes', 'electrify'); ?></option>
                <option value="false" <?php selected( $map_type_control, "false" ); ?>><?php _e('No', 'electrify'); ?></option>
            </select>
		</p>

		<p><label for="<?php echo $this->get_field_id('scale_control');?>"></label>
        <?php _e( 'Scale Control:','electrify' ) ?>
            <select id="<?php echo $this->get_field_id('scale_control');?>" name="<?php echo $this->get_field_name('scale_control');?>">
                <option value="true" <?php selected( $scale_control, "true" ); ?>><?php _e('Yes', 'electrify'); ?></option>
                <option value="false" <?php selected( $scale_control, "false" ); ?>><?php _e('No', 'electrify'); ?></option>
            </select>
		</p>

		<p><label for="<?php echo $this->get_field_id('street_view_control');?>"></label>
        <?php _e( 'Street View Control:','electrify' ) ?>
            <select id="<?php echo $this->get_field_id('street_view_control');?>" name="<?php echo $this->get_field_name('street_view_control');?>">
                <option value="true" <?php selected( $street_view_control, "true" ); ?>><?php _e('Yes', 'electrify'); ?></option>
                <option value="false" <?php selected( $street_view_control, "false" ); ?>><?php _e('No', 'electrify'); ?></option>
            </select>
		</p>

		<p><label for="<?php echo $this->get_field_id('overview_control');?>"></label>
        <?php _e( 'Overview Control:','electrify' ) ?>
            <select id="<?php echo $this->get_field_id('overview_control');?>" name="<?php echo $this->get_field_name('overview_control');?>">
                <option value="true" <?php selected( $overview_control, "true" ); ?>><?php _e('Yes', 'electrify'); ?></option>
                <option value="false" <?php selected( $overview_control, "false" ); ?>><?php _e('No', 'electrify'); ?></option>
            </select>
		</p>
