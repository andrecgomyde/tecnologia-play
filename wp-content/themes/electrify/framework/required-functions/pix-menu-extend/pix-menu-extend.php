...
electrify_require_file( THEME_FUNCTIONS .'/pix-menu-extend/pix_edit_custom_walker.php' );
electrify_require_file( THEME_FUNCTIONS .'/pix-menu-extend/pix_custom_walker.php' );

function pix_load_icon_fonts(){

	$pix_icon_font_json = json_encode( $GLOBALS['pix_icons_class_html'] );
