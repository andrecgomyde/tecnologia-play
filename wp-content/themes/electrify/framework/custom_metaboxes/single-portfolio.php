...
function pix_single_portfolio_options_cb($post)
{
	...
	echo '<h5 class="pix-sub-title">'.__('Multiple Images:','electrify'). '</h5>';
	echo '<p>'.__('You can select single or multiple images, if you select more than one images it act as a slider','electrify').'</p>';
	echo '</div>';
	...
	//Auto Slide
	echo '<div class="wrap-clear"><div class="pix-pull-left">';
	echo '<h5 class="pix-sub-title">'.__('Auto Slide:','electrify'). '</h5>';
	echo '<p><label for="pix_img_autoslide">'.__('To Enable autoplay or autoslide please type numeric value in milliseconds Ex: 2000, also you can enter true to set default duration(5000). Leave it blank or enter false to disable auto slide','electrify').'</label></p>';
	echo '</div>';
	...
	echo '<p><label for="pix_author_name">'.__('Name of the author one who created the project','electrify').'</label></p>';
	echo '</div>';
	echo '<div class="pix-pull-left">';
	...
	//client Name
	echo '<div class="wrap-clear"><div class="pix-pull-left">';
	echo '<h5 class="pix-sub-title">'.__('Client Name:','electrify'). '</h5>';
	echo '<p><label for="pix_client_name">'.__('Enter the client name.','electrify').'</label></p>';
	echo '</div>';
	echo '<div class="pix-pull-left">';
	...
	//Tasks
	echo '<div class="wrap-clear"><div class="pix-pull-left">';
	echo '<h5 class="pix-sub-title">'.__('Tasks:','electrify'). '</h5>';
	echo '<p><label for="pix_task">'.__('Tasks','electrify').'</label></p>';
	echo '</div>';
	echo '<div class="pix-pull-left">';
	...
	//Skills
	echo '<div class="wrap-clear"><div class="pix-pull-left">';
	echo '<h5 class="pix-sub-title">'.__('Skills:','electrify'). '</h5>';
	echo '<p><label for="pix_skills">'.__('Enter the skills you have used in this project ','electrify').'</label></p>';
	echo '</div>';
	echo '<div class="pix-pull-left">';
	...
	//Show Button
	echo '<div class="wrap-clear"><div class="pix-pull-left">';
	echo '<h5 class="pix-sub-title">'.__('Show/Hide Button:','electrify'). '</h5>';
	echo '<p>'.__('Do you want to display the launch button?','electrify').'</p>';
	echo '</div>';
	echo '<div class="pix-pull-left">';
	...
	//Project Button URL
	echo '<div class="wrap-clear"><div class="pix-pull-left">';
	echo '<h5 class="pix-sub-title">'.__('Project URL:','electrify'). '</h5>';
	echo '<p><label for="pix_portfolio_url">'.__('Type the URL of the project, if this field is empty the button wont display','electrify').'</label></p>';
	echo '</div>';
	echo '<div class="pix-pull-left">';
	...
	//Button Text
	echo '<div class="wrap-clear"><div class="pix-pull-left">';
	echo '<h5 class="pix-sub-title">'.__('Button Text:','electrify'). '</h5>';
	echo '<p><label for="pix_portfolio_text">'.__('Type the button text','electrify').'</label></p>';
	echo '</div>';
	echo '<div class="pix-pull-left">';
	...
	echo '<div class="wrap-clear"><div class="pix-pull-left">';
	echo '<h5 class="pix-sub-title">'.__('Taget:','electrify'). '</h5>';
	echo '<p>'.__('Do you want to open the project in new tab?','electrify').'</p>';
	echo '</div>';
	echo '<div class="pix-pull-left">';
	...
	echo '<p>'.__('Do you want to display the like button?','electrify').'</p>';
	echo '</div>';
	echo '<div class="pix-pull-left">';
	...
	echo '<p>'.__('Do you want to display the Social Share button ?','electrify').'</p>';
	echo '</div>';
	echo '<div class="pix-pull-left">';
	...
	echo '<p>'.__('Select the single portfolio style','electrify').'</p>';
	echo '</div>';
	echo '<div class="pix-pull-left">';
