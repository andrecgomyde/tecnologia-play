...
function pix_page_options_cb($post)
{
	...
	echo '<div id="PageOptions" class="verticalTab">';
		echo '<ul class="resp-tabs-list">
				<li class="tab-subpage">'.__('Sub Page Header Options','electrify'). '</li>
				<li class="tab-portfolio">'.__('Portfolio Options','electrify'). '</li>
				<li class="tab-pagelayout">'.__('Page Layout Options','electrify'). '</li>
			</ul>';
...
echo '<div class="resp-tabs-container">';
	...
	echo '<div class="header-options">';
		...
		echo '<div id="pix-header-size" class="float-clear">';
			echo '<div class="pix-pull-left">';
				echo '<h5 class="pix-sub-title">'.__('Sub Header:','electrify'). '</h5>';
				echo '<p>'.__('Changes this to hide/show sub header','electrify').'</p>';
			echo '</div>';
		...
		echo '<div id="pix-sub-header"'. $sub_style .'>';
			echo '<h5 class="pix-sub-title">'.__('Text style:','electrify'). '</h5>';
			echo '<p>'.__('Choose How you want to display text in sub banner.','electrify').'</p>';
			...
			echo '<div class="pix-pull-left">';
				echo '<h5 class="pix-sub-title">'.__('Header Size:','electrify'). '</h5>';
				echo '<p>'.__('This changes height of the header','electrify').'</p>
			</div>';
			...
			echo '<div id="pix-header-style">';
				echo '<div class="pix-pull-left">';
				echo '<h5 class="pix-sub-title">'.__('Header Background:','electrify'). '</h5>';
				echo '<p>'.__('By Change this, you can choose background image or background color and text color','electrify').'</p>
				</div>';
			...
			echo '<div class="pix-pull-left">';
				echo '<h5 class="pix-sub-title">'.__('Show/Hide Breadcrumbs:','electrify'). '</h5>';
				echo '<p>'.__('Changes this to hide/show breadcrumbs in header','electrify').'</p></div>';
			...
			echo '<div class="show_header_style" style="display:none">';
				...
				echo '<div id="header_bg_image">';
					echo '<div class="pix-pull-left">';
						echo '<h5 class="pix-sub-title">'.__('Insert Background:','electrify'). '</h5>';
						echo '<p class="pix_image_select pix-container">';
						echo '<label>'.__('Click below image add to Header background image','electrify').'</label></p>';
					echo '</div>';
				...
				echo '<div id="pix_color_picker">';
					...
					echo '<div class="pix-pull-left">';
						echo '<h5 class="pix-sub-title">'.__('Header background Color:','electrify'). '</h5>';
						echo '<p>'.__( 'Choose header bg color', 'electrify' ).'</p>';
					echo '</div>';
						echo '<div>';
					...
					echo '<div class="pix-pull-left">';
						echo '<h5 class="pix-sub-title">'.__('Header Text Color :','electrify'). '</h5>';
						echo '<p>'.__( 'Choose header bg color', 'electrify' ).'</p>';
					echo '</div>';	
					echo '<div>';
	...
	echo '<div id="pix-portfolio-options" class="show_portfolio_options" style="display:none">';
		...
		echo '<div id="pix-portfolio-layout-style" class="float-clear">';
			echo '<div class="pix-pull-left">';
			echo '<h5 class="pix-sub-title">'.__('Portfolio Layout:','electrify'). '</h5>';
			echo '<p>'.__('Choose Portfolio Layout style.','electrify').'</p>';
			echo '</div>';
		...
		echo '<div class="pix-pull-left">';
			echo '<h5 class="pix-sub-title">'.__('Portfolio Styles:','electrify'). '</h5>';
		echo '</div>';	
			...
			echo '</select></div>
			<p>'.__('Choose a Portfolio Page Style. <br><strong>Extended:</strong> Portfolio display from the browser edge. <br><strong>Boxed:</strong> Portfolio display centered & inside container.<br><strong>Boxed with margin:</strong> Same as above but display with margin.','electrify').'</p>';
		echo '</div>';
		...
		echo '<div id="pix-columns" '. $style .' class="float-clear">';
			echo '<div class="pix-pull-left">';	
			echo '<h5 class="pix-sub-title">'.__('Portfolio Columns:','electrify'). '</h5>';
			echo '<p>'.__('Choose the columns:','electrify').'</p>';
echo '</div>';
		...
		echo '<h5 class="pix-sub-title">'.__('Portfolio Hover Styles:','electrify'). '</h5>';
		echo '<p>'.__('This theme consists of 6 hover style. Choose a Hover style,:','electrify');
		...
		echo '<div id="pix-filter-options">';
			...
			echo '<div id="pix-is-filterable" class="float-clear">';
				echo '<div class="pix-pull-left">';
					echo '<h5 class="pix-sub-title">'.__('Filterable:','electrify'). '</h5>';
					echo '<p>'.__('If yes, filter menu will dispaly','electrify').'</p>';
				echo '</div>';

				echo '<div class="select-style on-off-switch"> <select name="pix_filterable" class="widefat pix-switch">';
				echo '<option value="yes"'. (($pix_filterable == "yes") ? ' selected="selected"' : ''). '>' . __('Yes','electrify'). '</option>';
				echo '<option value="no"'. (($pix_filterable == "no") ? ' selected="selected"' : ''). '>' . __('No','electrify'). '</option>'; 
				echo '</select></div>';
			echo '</div>';

			echo '<div id="pix-filter-style" class="float-clear">';
				echo '<div class="pix-pull-left">';
					echo '<h5 class="pix-sub-title">'.__('Filter Style:','electrify'). '</h5>';
					echo '<p>'.__('Choose filter style','electrify').'</p>';
				echo '</div>';	
				echo '<div class="select-style"><select name="pix_filter_style" class="widefat pix-switch">';
				echo '<option value="normal simple"'. (($pix_filter_style == "normal simple") ? ' selected="selected"' : ''). '>' . __('Simple style','electrify'). '</option>';
				echo '<option value="dropdown"'. (($pix_filter_style == "dropdown") ? ' selected="selected"' : ''). '>' . __('Dropdown style','electrify') . '</option>';
				echo '<option value="normal"'. (($pix_filter_style == "normal") ? ' selected="selected"' : ''). '>' . __('Menu style','electrify'). '</option>'; 
				echo '</select></div>';
			echo '</div>';

			echo '<div id="pix-lightbox" class="float-clear">';
				echo '<div  class="pix-pull-left">';
					echo '<h5 class="pix-sub-title">'.__('Lightbox:','electrify'). '</h5>';
					echo '<p>'.__('Do you want to display lightbox?','electrify').'</p>';
				echo '</div>';
				echo '<div class="select-style on-off-switch"><select name="pix_lightbox" class="widefat pix-switch">';
				echo '<option value="yes"'. (($pix_lightbox == "yes") ? ' selected="selected"' : ''). '>' . __('Yes','electrify') . '</option>';
				echo '<option value="no"'. (($pix_lightbox == "no") ? ' selected="selected"' : ''). '>' . __('No','electrify'). '</option>'; 
				echo '</select></div>';
			echo '</div>';

			echo '<div id="pix-single-portfolio-link" class="float-clear">';
			 echo '<div class="pix-pull-left">';
				echo '<h5 class="pix-sub-title">'.__('Single Portfolio Link:','electrify'). '</h5>';
				echo '<p>'.__('Do you want to display single portfolio link?','electrify').'</p>';
			 echo '</div>';
				echo '<div class="select-style on-off-switch"> <select name="pix_single_portfolio_link" class="widefat pix-switch">';
				echo '<option value="yes"'. (($pix_single_portfolio_link == "yes") ? ' selected="selected"' : ''). '>' . __('Yes','electrify') . '</option>';
				echo '<option value="no"'. (($pix_single_portfolio_link == "no") ? ' selected="selected"' : ''). '>' . __('No','electrify'). '</option>'; 
				echo '</select></div></p>';
			echo '</div>';

			echo '<div id="pix-share" class="float-clear">';
				echo '<div class="pix-pull-left">';
				echo '<h5 class="pix-sub-title">'.__('Order:','electrify'). '</h5>';
				echo '<p>'.__('Sorting method of portfolio items','electrify').'</p>';
				echo '</div>';
				echo '<div class="select-style"> <select name="pix_order" class="widefat pix-switch">';
				echo '<option value="asc"'. (($pix_order == "asc") ? ' selected="selected"' : ''). '>' . __('Ascending','electrify') . '</option>';
				echo '<option value="desc"'. (($pix_order == "desc") ? ' selected="selected"' : ''). '>' . __('Descending','electrify'). '</option>'; 
				echo '</select></div></p>';
			echo '</div>';

			echo '<div id="pix-order-by" class="float-clear">';
				echo '<div class="pix-pull-left">';
				echo '<h5 class="pix-sub-title">'.__('Order By:','electrify'). '</h5>';
				echo '<p>'.__('How to sort the portfolio items?','electrify').'</p>';
				echo '</div>';
				echo '<div class="select-style"> <select name="pix_order_by" class="widefat">';
				echo '<option value="date"'. (($pix_order_by == "date") ? ' selected="selected"' : ''). '>' . __('Date','electrify') . '</option>';
				echo '<option value="title"'. (($pix_order_by == "title") ? ' selected="selected"' : ''). '>' . __('Title','electrify'). '</option>';
				echo '<option value="rand"'. (($pix_order_by == "rand") ? ' selected="selected"' : ''). '>' . __('Random','electrify'). '</option>'; 
				echo '</select></div>';
			echo '</div>';

			echo '<div id="pix-like" class="float-clear">';
				echo '<div class="pix-pull-left">';
				echo '<h5 class="pix-sub-title">'.__('Like Button:','electrify'). '</h5>';
				echo '<p>'.__('Do you want to display like button?','electrify').'</p>';
				echo '</div>';
				echo '<div class="select-style on-off-switch"> <select name="pix_like" class="widefat pix-switch">';
				echo '<option value="yes"'. (($pix_like == "yes") ? ' selected="selected"' : ''). '>' . __('Yes','electrify') . '</option>';
				echo '<option value="no"'. (($pix_like == "no") ? ' selected="selected"' : ''). '>' . __('No','electrify'). '</option>'; 
				echo '</select></div>';
			echo '</div>';

			echo '<div id="pix-share" class="float-clear">';
				echo '<div class="pix-pull-left">';
				echo '<h5 class="pix-sub-title">'.__('Share Button:','electrify'). '</h5>';
				echo '<p>'.__('Do you want to display share button?','electrify').'</p>';
				echo '</div>';
				echo '<div class="select-style on-off-switch"><select name="pix_share" class="widefat pix-switch">';
				echo '<option value="yes"'. (($pix_share == "yes") ? ' selected="selected"' : ''). '>' . __('Yes','electrify') . '</option>';
				echo '<option value="no"'. (($pix_share == "no") ? ' selected="selected"' : ''). '>' . __('No','electrify'). '</option>'; 
				echo '</select></div>';
			echo '</div>';
		...
		echo '<div>';
			echo '<div class="pix-portfolio-items float-clear">';
				echo '<div class="pix-pull-left">';
				echo '<h5 class="pix-sub-title">'.__('Number of Portfolio Items','electrify'). '</h5>';
				echo '<p>';
				echo '<label for="no_of_posts_per_page">'.__('Enter how many items you want to display <br>(posts per page)','electrify').':</label>';
				echo '</p>';
				echo '</div>';
				echo '<div class="pix-pull-left">';
			...
			echo '<div class="pix-pagination float-clear">';
				echo '<div class="pix-pull-left">';
				echo '<h5 class="pix-sub-title">'.__('Pagination','electrify'). '</h5>';
				echo '<p>'.__('Do you like display pagination? It helps you to display portfolio in multiple pages','electrify').'</p>';
				echo '</div>';
	...
	echo '<div id="pix-layout-options">';
		//Layout Settings
		echo '<h5 class="pix-sub-title">'.__('Layout Settings:','electrify'). '</h5>';
		echo '<p>'.__('Choose Layout for this page','electrify');
		...
		echo '	<div class="pix-pull-left">';
			echo '<h5 class="pix-sub-title">'.__('Choose Sidebar for this page:','electrify'). '</h5>';
			echo "<p>";
			_e('Please select the sidebar you would like to display on this page. <strong>Note:</strong> You can create the sidebar under Appearance > Sidebars','electrify');
			echo "</p>";
		echo '</div>';
	...
	echo '</div>';
		...
		echo '<div id="pix-dot-navigation" class="wrap-clear">';
			echo '<div class="pix-pull-left">';
				echo '<h5 class="pix-sub-title">'.__('Dot Navigation:','electrify'). '</h5>';
				echo '<p>'.__('Do you want dot Navigation?','electrify').'</p>';
			echo '</div>';
