...
function pix_post_options_cb($post)
{
	...
	echo '<div class="img_gallery_show clearfix">';
		...
		echo '<h5 class="pix-sub-title">'.__('Gallery:','electrify'). '</h5>';
		echo '<p class="pix_image_select">';
		echo '<label for="pix_images">'.__('Select the images for gallery','electrify').'</label>
		</p></div>';
		...
		<div class="pix-pull-left"><h5 class="pix-sub-title">'.__('Auto Slide:','electrify'). '</h5>';
		
		echo '<p><label for="pix_img_autoslide">'.__('To Enable autoplay or autoslide please type numeric value in milliseconds Ex: 2000, also you can enter true to set default duration(5000). Leave it blank or enter false to disable auto slide','electrify').'</label></p></div>';
...
echo '</div>';
	...
	echo '<div id="video_methods_show" class="wrap-clear">';
		//Video Methods
	echo '<div class="pix-pull-left">';
		echo '<h5 class="pix-sub-title">'.__('Video Methods:','electrify'). '</h5>';
		echo '<p>'.__('Choose the video methods such as (Direct insert or Iframe)','electrify').'</p>';
echo '</div>';
	...
	echo '<div class="wrap-clear">';
		echo '<div class="pix-pull-left">';
			echo '<h5 class="pix-sub-title">'.__('Video Normal:','electrify'). '</h5>';
			echo '<p><label for="vid_url">'.__('Choose or Upload video from Media Uploader','electrify').'</label></p>';
		echo '</div>';
	...
	echo '<div class="wrap-clear">';
		echo '<div class="pix-pull-left">';
		echo '<h5 class="pix-sub-title">'.__('Poster:','electrify'). '</h5>';
		echo '<p class="pix_image_select">';
		echo '<label for="vid_poster">'.__('Choose or Upload image from Media Uploader for video poster','electrify').'</label></p>';
		echo '</div>';
	...
	echo '<div class="wrap-clear">';
		echo '<div class="pix-pull-left">';
		echo '<h5 class="pix-sub-title">'.__('Autoplay:','electrify'). '</h5>';
		echo '<p>'.__('If it\'s true, the videos plays automatically when the page loads','electrify').' </p>';
		echo '</div>';
	...
	echo '<div id="vid_iframe_show" class="wrap-clear">';
		...
		echo '<div class="pix-pull-left">';
		echo '<h5 class="pix-sub-title">'.__('Video Iframe:','electrify'). '</h5>';
		echo '<p><label for="pix_vid_iframe">'.__('Enter Video iframe (<em>Please enter embed code form YouTube / Vimeo / Blip.tv / Viddler / Kickstarter </em>)','electrify').'</label></p>';
		echo '</div>';
		echo '<div class="pix-pull-left">';
	...
	if($wp_version >= '3.9'){
		echo '<div id="vid_playlist_show" class="wrap-clear">';
			//Select Video
		echo '<div class="pix-pull-left">';
			echo '<h5 class="pix-sub-title">'.__('Video Playlist:','electrify'). '</h5>';
			echo '<p><label for="vid_playlist">'.__('Choose or Upload video from Media Uploader','electrify').'</label>
			</p>';
			echo '</div>';
			echo '<div class="pix-pull-left pix-container pix_video_select">';
	...
	*/
	...
	echo '<div id="audio_methods_show" class="wrap-clear">';
		//Audio Methods
		echo '<div class="pix-pull-left">';
			echo '<h5 class="pix-sub-title">'.__('Audio Methods:','electrify'). '</h5>';
			echo '<p>'.__('Choose the audio methods such as (Direct insert or Iframe)','electrify').'</p>';
		echo '</div>';
	...
	echo '<div class="aud_normal_show">';
		...
		echo '<div class="wrap-clear"><div class="pix-pull-left">';
			echo '<h5 class="pix-sub-title">'.__('Select Audio:','electrify'). '</h5>';
			echo '<p><label for="pix_audio">'.__('Choose or Upload video from Media Uploader','electrify').'</label></p>';
		echo '</div>';
		...
		//Autoplay
		echo '<div class="wrap-clear"><div class="pix-pull-left">';
		echo '<h5 class="pix-sub-title">'.__('Autoplays:','electrify'). '</h5>'; 
		echo '<p>'.__('If it\'s true, the audio plays automatically when the page loads','electrify').'</p>';
		echo '</div>';
	...
	echo '<div id="aud_iframe_show" class="wrap-clear">';
		//Audio Iframe
		echo '<div class="pix-pull-left">';
		echo '<h5 class="pix-sub-title">'.__('Audio Iframe:','electrify'). '</h5>'; 
		echo '<p><label for="pix_aud_iframe">'.__('Enter Audio iframe (<em>Please enter embed code like soundcloud </em>)','electrify').'</label></p>';
		echo '</div>';
		echo '<div class="pix-pull-left">';
	...
	if($wp_version >= '3.9'){
		echo '<div id="aud_playlist_show" class="wrap-clear">';
			//Select Audio
		echo '<div class="pix-pull-left">';
			echo '<h5 class="pix-sub-title">'.__('Audio Playlist:','electrify'). '</h5>';
			echo '<p><label for="aud_playlist">'.__('Choose or Upload audio from Media Uploader','electrify').'</label></p>';
		echo '</div>';
	...
	echo '<div class="pix-pull-left">';
		echo '<h5 class="pix-sub-title">'.__('Link:','electrify'). '</h5>';
		echo '<p>';
		echo '<label for="pix_link">'.__('Type the external link it applies only in link post format','electrify').'</label></p>';
	echo '</div>';
		echo '<div class="pix-pull-left">';	
	...
	echo '<div class="pix-pull-left">';	
		echo '<h5 class="pix-sub-title">'.__('Author:','electrify'). '</h5>';
		echo '<p>';
		echo '<label for="pix_quote_author">'.__('Enter the Author Name it applies only in quote post format','electrify').'</label></p>';
		echo'</div>';
		echo '<div class="pix-pull-left">';	
